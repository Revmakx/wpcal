...
class WPCal_TP_Google_Calendar extends WPCal_Abstract_TP_Calendar
{
	...
	private $api_client_keys = '{"web":{"client_id": "__CLIENT_ID_HERE__","project_id": "__PROJECT_ID_HERE__","auth_uri": "https://accounts.google.com/o/oauth2/auth","token_uri": "https://oauth2.googleapis.com/token","auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs","client_secret": "__CLIENT_SECRET_HERE__"}}';
	...
	public function api_update_event_location($cal_details, WPCal_Booking $booking_obj)
	{ //purpose of this method is when google meet meeting is required, first it will send temporary url as location. Now it will be updated with original url.
		$this->set_api();
	...
	public function api_add_calendar_events_webhook($tp_cal_id, $webhook_data)
	{ //watch - webhook
	...
	public function api_stop_calendar_events_webhook($tp_cal_id, $webhook_data)
	{ //watch - webhook
